...
export declare const setSelectedByPath: import("@reduxjs/toolkit").ActionCreatorWithPayload<any, string>, addSelected: import("@reduxjs/toolkit").ActionCreatorWithPayload<any, string>, removeLastSelected: import("@reduxjs/toolkit").ActionCreatorWithoutPayload<string>, removeDeletedDirectories: import("@reduxjs/toolkit").ActionCreatorWithPayload<File, string>;
